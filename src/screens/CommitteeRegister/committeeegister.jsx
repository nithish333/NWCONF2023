...
export const CommitteeRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (firstName !== "" && lastName !== "" && email !== "" && confirmEmail !== "" && password !== "") {
            await axios.post("http://127.0.0.1:5000/committeereg",{"Email":email,"Password":password,"FirstName":firstName,"LastName":lastName,"Aoi":interests})
           const user = {"Email":email,"FirstName":firstName,"LastName":lastName,"Aoi":interests,"Password":password}
            navigate("/committee/home",{state:{name:user}})
        }
    };
